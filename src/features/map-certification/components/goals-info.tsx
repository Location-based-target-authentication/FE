...
function GoalsInfo({ name, timeString, dayString }: GoalsInfoProps) {
  return (
    <div className="absolute left-1/2 top-0 z-20 mx-auto mt-4 w-[95%] max-w-md -translate-x-1/2 rounded-xl border border-gray-200 bg-green-50 p-5 shadow-lg">
      <div className="relative flex items-center justify-between gap-4">
        <div>
          <p className="mb-3 text-xl text-green-700">{name}</p>
          <p className="mb-1 flex items-center text-[13px]">
